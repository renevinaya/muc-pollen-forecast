...
- **The slope.** Accuracy is flat across the horizon — 35.8% at day 1 to 33.9%
  at day 5 — because the model is direct rather than recursive. The old decay
  dropped 32 points over that span.
